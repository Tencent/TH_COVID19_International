...
<!--
 * @Author: shallwe
 * @Date: 2020-02-10 22:30:36
 * @LastEditTime : 2020-02-13 10:50:52
 * @LastEditors  : shallwe
 -->
    ...
    <div class="container nearby-selector-wrap">
        <div class="selector-box" :class="{ close: isClose }">
            ...
            <div class="select-tip-wrap" v-if="!disableTip">
                <span>当前已支持查看{{ cityCount }}个城市的确诊小区，更多城市正在解锁中</span>
            </div>
        ...
        setContent (index, name, key, list) {
            ...
            if (name) {
                ...
                if (this[`content${index}Index`]) {
                    ...
                    if (key === 'label') {
                        this.handleChoose(selected, index, index !== 3)
                    }
                }
            }
